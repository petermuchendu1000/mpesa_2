package com.huawei.customer.digitalpayment.scan;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    private static final SparseIntArray component1 = new SparseIntArray(0);

    @Override
    public ViewDataBinding getDataBinder(DataBindingComponent dataBindingComponent, View view, int i) {
        if (component1.get(i) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public int getLayoutId(String str) {
        Integer num;
        if (str == null || (num = copydefault.component3.get(str)) == null) {
            return 0;
        }
        return num.intValue();
    }
    ...
    public String convertBrIdToString(int i) {
        return component2.component3.get(i);
    }
