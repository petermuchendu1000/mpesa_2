package com.huawei.customer.digitalpayment.checkout;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    private static final SparseIntArray copydefault = new SparseIntArray(0);
    ...
    public String convertBrIdToString(int i) {
        return copydefault.component2.get(i);
    }
