...
public class BasicInputEditTextBindingImpl extends BasicInputEditTextBinding {
    ...
    public BasicInputEditTextBindingImpl(DataBindingComponent dataBindingComponent, View[] viewArr) {
        this(dataBindingComponent, viewArr, mapBindings(dataBindingComponent, viewArr, 10, component3, component1));
    }

    private BasicInputEditTextBindingImpl(DataBindingComponent dataBindingComponent, View[] viewArr, Object[] objArr) {
