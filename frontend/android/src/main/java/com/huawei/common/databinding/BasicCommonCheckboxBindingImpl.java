...
public class BasicCommonCheckboxBindingImpl extends BasicCommonCheckboxBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tvCheckBox, 2);
    }

    public BasicCommonCheckboxBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, copydefault, component2));
    }

    private BasicCommonCheckboxBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
