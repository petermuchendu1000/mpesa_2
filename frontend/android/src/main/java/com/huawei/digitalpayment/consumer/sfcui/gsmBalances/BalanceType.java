...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u001e\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000fj\u0002\b\u0010j\u0002\b\u0011j\u0002\b\u0012j\u0002\b\u0013j\u0002\b\u0014j\u0002\b\u0015j\u0002\b\u0016j\u0002\b\u0017j\u0002\b\u0018j\u0002\b\u0019j\u0002\b\u001aj\u0002\b\u001bj\u0002\b\u001cj\u0002\b\u001dj\u0002\b\u001ej\u0002\b\u001fj\u0002\b ¨\u0006!"}, d2 = {"Lcom/huawei/digitalpayment/consumer/sfcui/gsmBalances/BalanceType;", "", "type", "", "<init>", "(Ljava/lang/String;ILjava/lang/String;)V", "getType", "()Ljava/lang/String;", "AIRTIME", "DATA", PermissionConstants.SMS, "BONGA", "CREDIT_LIMIT", "POSTPAID", "VOICE", "CALLS_AND_SMS", "FLEX_BUNDLES", "TUNUKIWA_DATA", "TUNUKIWA_AIRTIME", "TUNUKIWA_VOICE", "TUNUKIWA_HOURLY_VOICE", "TUNUKIWA_DAILY_VOICE", "TUNUKIWA_HOURLY_MINUTES", "TUNUKIWA_DAILY_MINUTES", "TUNUKIWA_DATA_DAILY", "TUNUKIWA_DATA_HOURLY", "TUNUKIWA_SMS_HOURLY", "TUNUKIWA_SMS_DAILY", "TUNUKIWA_SMS", "TUNUKIWA_TALKTIME", "ROAMING_DATA", "CORPORATE_VOICE", "UNLIMITED_OFFER", "ConsumerSfcUI_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class BalanceType {
    ...
    public static BalanceType valueOf(String str) {
        ...
        component1 = i2 % 128;
        int i3 = i2 % 2;
        BalanceType balanceType = (BalanceType) Enum.valueOf(BalanceType.class, str);
    ...
    public static BalanceType[] values() {
        BalanceType[] balanceTypeArr;
        int i = 2 % 2;
        int i2 = component2 + 111;
        component1 = i2 % 128;
        if (i2 % 2 == 0) {
            balanceTypeArr = (BalanceType[]) $VALUES.clone();
            int i3 = 61 / 0;
        } else {
            balanceTypeArr = (BalanceType[]) $VALUES.clone();
        }
