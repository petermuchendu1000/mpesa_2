...
import kotlin.ReportDrawnCompositionsnapshotStateObserver1;
...
public final class SendToBankActivity$special$$inlined$viewModels$default$2 extends Lambda implements Function0<ViewModelStore> {
    ...
    public final ViewModelStore invoke() {
        ...
        component3 = i2 % 128;
        if (i2 % 2 != 0) {
            viewModelStore = this.$this_viewModels.getViewModelStore();
            int i3 = 82 / 0;
        } else {
            viewModelStore = this.$this_viewModels.getViewModelStore();
        }
    ...
    public SendToBankActivity$special$$inlined$viewModels$default$2(ComponentActivity componentActivity) {
        super(0);
        this.$this_viewModels = componentActivity;
    }

    public static void component2() {
        ReportDrawnCompositionsnapshotStateObserver1.component2[0] = ReportDrawnCompositioncheckReporter1.ShareDataUIState[0];
    }
}
