...
public final class Header implements Parcelable {
    ...
    public static Header copy$default(Header header, String str, int i, String str2, String str3, String str4, int i2, Object obj) {
        ...
        return header.copy(str5, i6, str7, str8, str4);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual(this.requestRefId, header.requestRefId)) {
            int i4 = component2 + 67;
            component3 = i4 % 128;
            return i4 % 2 == 0;
        }
        if (this.responseCode != header.responseCode) {
