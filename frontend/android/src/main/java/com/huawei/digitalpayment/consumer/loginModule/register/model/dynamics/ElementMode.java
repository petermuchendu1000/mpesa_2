...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, d2 = {"Lcom/huawei/digitalpayment/consumer/loginModule/register/model/dynamics/ElementMode;", "", "<init>", "(Ljava/lang/String;I)V", "CREATE", "EDIT", "VIEW", "ConsumerLoginModule_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class ElementMode {
    ...
    private static final ElementMode[] $values() {
        ...
        if (i2 % 2 != 0) {
            ...
            elementModeArr = new ElementMode[5];
            elementModeArr[1] = elementMode;
            elementModeArr[1] = elementMode2;
            elementModeArr[3] = elementMode3;
        } else {
    ...
    public static EnumEntries<ElementMode> getEntries() {
        ...
        copydefault = i3 % 128;
        int i4 = i3 % 2;
        EnumEntries<ElementMode> enumEntries = $ENTRIES;
        int i5 = i2 + 73;
        copydefault = i5 % 128;
        int i6 = i5 % 2;
        return enumEntries;
